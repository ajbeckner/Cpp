...
bool isSet(SetCard a, SetCard b, SetCard c ){
    bool isShape = (a.getShape() == b.getShape() && a.getShape() == c.getShape()) || (a.getShape() != b.getShape() && a.getShape() != c.getShape() && c.getShape() != b.getShape());
    bool isShade = (a.getShade() == b.getShade() && a.getShade() == c.getShade()) || (a.getShade() != b.getShade() && a.getShade() != c.getShade() && c.getShade() != b.getShade());
    bool isColor = (a.getColor() == b.getColor() && a.getColor() == c.getColor()) || (a.getColor() != b.getColor() && a.getColor() != c.getColor() && c.getColor() != b.getColor());
    bool isNumber = (a.getNumber() == b.getNumber() && a.getNumber() == c.getNumber()) || (a.getNumber() != b.getNumber() && a.getNumber() != c.getNumber() && c.getNumber() != b.getNumber());
    
    return (isShape && isShade && isColor && isNumber);
}
