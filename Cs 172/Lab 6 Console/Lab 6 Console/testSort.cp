...
//----------------------------------------------------------------------------
    ...
    int binary_search(vector<int> &v, int fromIndex, int toIndex, int key) ;
...
//----------------------------------------------------------------------------
	...
	int main(void)
	{
        ...
        //---------------------------------------------------------------------
        // Sort the list with fasterSort and report the results
        //---------------------------------------------------------------------
...
int binary_search(vector<int> &v, int fromIndex, int toIndex, int key)
{
    ...
    if (diff == 0) /* v[mid] == key */
        ...
        return binary_search(v, mid + 1, toIndex, key);
    else
        return binary_search(v, fromIndex, mid - 1, key);
}
